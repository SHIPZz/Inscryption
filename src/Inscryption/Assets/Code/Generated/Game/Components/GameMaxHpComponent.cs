...
public partial class GameEntity {
    ...
    public Code.Common.MaxHp maxHp { get { return (Code.Common.MaxHp)GetComponent(GameComponentsLookup.MaxHp); } }
    public int MaxHp { get { return maxHp.Value; } }
    public bool hasMaxHp { get { return HasComponent(GameComponentsLookup.MaxHp); } }

    public GameEntity AddMaxHp(int newValue) {
        var index = GameComponentsLookup.MaxHp;
        var component = (Code.Common.MaxHp)CreateComponent(index, typeof(Code.Common.MaxHp));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceMaxHp(int newValue) {
        var index = GameComponentsLookup.MaxHp;
        var component = (Code.Common.MaxHp)CreateComponent(index, typeof(Code.Common.MaxHp));
        component.Value = newValue;
