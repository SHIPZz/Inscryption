...
public partial class GameEntity {
    ...
    public Code.Common.NameComponent name { get { return (Code.Common.NameComponent)GetComponent(GameComponentsLookup.Name); } }
    ...
    public GameEntity AddName(string newValue) {
        ...
        var component = (Code.Common.NameComponent)CreateComponent(index, typeof(Code.Common.NameComponent));
