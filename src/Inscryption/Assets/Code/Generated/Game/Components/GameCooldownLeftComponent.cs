...
public partial class GameEntity {
    ...
    public Code.Features.Cooldowns.CooldownLeft cooldownLeft { get { return (Code.Features.Cooldowns.CooldownLeft)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.Features.Cooldowns.CooldownLeft)CreateComponent(index, typeof(Code.Features.Cooldowns.CooldownLeft));
