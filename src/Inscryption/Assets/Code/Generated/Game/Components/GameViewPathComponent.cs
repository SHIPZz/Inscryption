...
public partial class GameEntity {
    ...
    public Code.Features.View.ViewPath viewPath { get { return (Code.Features.View.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (Code.Features.View.ViewPath)CreateComponent(index, typeof(Code.Features.View.ViewPath));
