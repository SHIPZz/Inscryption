...
public partial class GameEntity {
    ...
    public Code.Features.View.ViewPrefab viewPrefab { get { return (Code.Features.View.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public Code.Features.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Code.Features.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.Features.View.ViewPrefab)CreateComponent(index, typeof(Code.Features.View.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(Code.Features.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.Features.View.ViewPrefab)CreateComponent(index, typeof(Code.Features.View.ViewPrefab));
        component.Value = newValue;
